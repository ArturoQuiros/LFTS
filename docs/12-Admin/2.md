...
Para crear el post primero modificamos la vista de **create.blade** mediante un _form_
...
Modificamos el **PostController** para la funcion _store_
...
Y agregamos la ruta en **web.php**
